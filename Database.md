...
1.  **The User:** Taps "View Profile" in the App.
2.  **The API:** Receives the request and asks the Database: *"Hey, give me the row where ID = 123."*
3.  **The Database:** Searches its tables, finds the row, and sends it back to the API.
4.  **The Result:** The API formats that data and sends it to the App.

⚠️ **Crucial Rule:** The App never talks to the Database directly ❌. Only the **Backend (API)** has the key to the cupboard ✅.
...
* **Concept:** Think of this as a **Strict Spreadsheet**.
* **Rule:** Data must fit perfectly into defined columns.
* **Best for:** Payments, User accounts, and Structured data.

### **NoSQL (Non-Relational)**
* **Example:** MongoDB.
* **Concept:** Think of this as a **Folder of Documents**.
* **Rule:** Data can be flexible; one entry might have more info than another.
