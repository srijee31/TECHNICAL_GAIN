...
Before Local Storage, websites had a problem:
...
In simple words: Local Storage is a space in your browser where a website can save data permanently.
...
The Locker: You have a locker in your own room.
...
The Action: You switch a website to "Dark Mode."
The Save: The website’s JavaScript writes a tiny note in your browser: theme: dark.
The Shutdown: You close the tab. You restart your phone. You wait three days.
The Return: You open the site again. The website's code immediately checks the locker: "Is there a theme saved? Yes, it says 'dark'."
The Result: The site loads in Dark Mode instantly without asking the server.
...
Clear your Cookies.
Refresh the page.
Is your Dark Mode still there? If yes, that's Local Storage. It survived the cookie clearing because it's stored in a different "locker."
